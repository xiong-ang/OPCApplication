...
namespace OPC
{
    ...
    public struct Item
    {
        public Item(string itemId, int clientId, VarEnum requestedDataType, VarEnum requestedDataSubType, bool active, string accessPath)
        {
            ItemId=itemId;
            ClientId = clientId;
            RequestedDataType = requestedDataType;
            RequestedDataSubType = requestedDataSubType;
            Active = active;
