========================================================================
    ACTIVE TEMPLATE LIBRARY : OPCServer Project Overview
========================================================================

AppWizard has created this OPCServer project for you to use as the starting point for
...
OPCServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (OPCServer.h)
        GUID definitions                                (OPCServer_i.c)
        A type library                                  (OPCServer.tlb)
        Marshaling code                                 (OPCServer_p.c and dlldata.c)

OPCServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in OPCServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named OPCServer.pch and a precompiled types file named StdAfx.obj.
...
OPCServerps.vcxproj
	...
	dlldata.c, OPCServer_i.c and OPCServer_p.c which are required
	to build the proxy/stub DLL.

OPCServerps.vcxproj.filters
